...
const initialPosts = [
    {
        userName: 'Anonymous1',
        collegeName: 'Latreen University',
        title: 'No latreen in Latreen Univerisity',
        ...
        Likes: 0,
        comments: [
            { userName: 'Anonymous7', text: 'Facts!' },
            { userName: 'Anonymous8', text: 'TMKC delete karde app bsdk'}
        ]
    },
    {
        userName: 'Anonymous2',
        ...
        Likes: 0,
        comments: [
            { userName: 'Anonymous9',  text: 'Ok ok ok!' },
            { userName: 'Anonymous10', text: 'Woahh!!' },
            { userName: 'Anonymous11', text: 'Saalloooo mera bhi ho gaya off campus tha'},
            { userName: 'Anonymous12', text: 'LMAAOOO, aur krlo private naukri!!'}
        ]
    ...
    },
    {
        ...
        Likes: 0,
        comments: [
            { userName: 'Anonymous13', text: 'Iski Maa kaa!!'},
            { userName: 'Anonymous14', text: 'Hold upp broo...whhhaaaa!!'}
        ]
    }
];
